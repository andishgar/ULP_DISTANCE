...
def main():
    ...
    json1 = json1_orig =util.sort_benchmark_results(
       util.run_or_load_benchmark(
            test_baseline, benchmark_options + options_baseline
        )
    )
    json2 = json2_orig =util.sort_benchmark_results(
       util.run_or_load_benchmark(
    ...
    if filter_baseline and filter_contender:
        ...
        json1 =report.filter_benchmark(
            json1_orig, filter_baseline, replacement
        )
        json2 =report.filter_benchmark(
            json2_orig, filter_contender, replacement
        )

    diff_report =report.get_difference_report(json1, json2, args.utest)
